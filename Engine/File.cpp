...
std::string nu::GetWorkingDirectory()
{
    std::error_code ec;
...
bool nu::SetWorkingDirectory(const std::string& path)
{
    std::error_code ec;
...
std::string nu::GetFilename(const std::string& path)
{
    // create path object from string, return filename
    return std::filesystem::path{ path }.filename().string();
}

std::string nu::GetFileExtension(const std::string& path)
{
    // create path object from string, return extension
    return std::filesystem::path{ path }.extension().string();
}

std::string nu::GetFilenameNoExtension(const std::string& path)
{
    // create path object from string, return filename no extension
    return std::filesystem::path{ path }.stem().string();
}

bool nu::FileExists(const std::string& path)
{
    std::error_code ec;
...
std::vector<std::string> nu::GetFilesInDirectory(const std::string& path)
{
...
std::vector<std::string> nu::GetDirectoriesIn(const std::string& path)
{
...
bool nu::ReadTextFile(const std::string& path, std::string& data)
{
...
bool nu::WriteTextFile(const std::string& path, const std::string& data, bool append)
{
    // create input file stream
